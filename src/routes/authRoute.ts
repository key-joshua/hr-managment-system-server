...
router.post('/signup', multipart, routeHeaderValidation(userDeviceSchema),  uploadSingleFileService, routeBodyValidation(signupSchema), isUserExist, authController.signup);
